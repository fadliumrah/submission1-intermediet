...
object Helper {
    ...
    fun dialogInfoBuilder(context: Context, message: String, alignment: Int = Gravity.CENTER): Dialog {
    ...
    fun createFile(application: Application): File {
        ...
        return File(outputDirectory, "STORY.jpg")
    }

    private fun createCustomTempFile(context: Context): File {
        val storageDir: File? = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES)
        return File.createTempFile(toString(), ".jpg", storageDir)
    }
